package com.pi4j.extension.addonboard.io;
 ...
 * FILENAME      :  AddOnBoardIOAddressConfigBuilderBase.java
 *
...
/**
 * <p>Abstract AddOnBoardIOAddressConfigBuilderBase class.</p>
 *
 * @author Robert Savage (<a href="http://www.savagehomeautomation.com">http://www.savagehomeautomation.com</a>)
 * @version $Id: $Id
 * @param <BUILDER_TYPE> Add-on board config builder type
 * @param <CONFIG_TYPE> Add-on board config type
 */
public abstract class AddOnBoardIOAddressConfigBuilderBase<BUILDER_TYPE extends ConfigBuilder, CONFIG_TYPE extends Config>
     ...
     */
    protected AddOnBoardIOAddressConfigBuilderBase(Context context){
        super(context);
    }
